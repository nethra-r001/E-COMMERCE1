...
function SignupForm() {
  ...
  return (
    <div className="card glass-card animate-slide" style={{ maxWidth: '450px', width: '100%', padding: '40px' }}>
      <div style={{ textAlign: 'center', marginBottom: '32px' }}>
        <h2 style={{ fontSize: '32px', marginBottom: '8px', fontWeight: '800' }}>Create Account</h2>
      ...
      <div style={{ marginTop: '28px', textAlign: 'center', fontSize: '14px', color: 'var(--text-secondary)' }}>
        ...
        <Link href="/login" style={{ color: 'var(--primary)', fontWeight: '600' }} className="btn-link">
          Log in
        </Link>
      </div>
    </div>
