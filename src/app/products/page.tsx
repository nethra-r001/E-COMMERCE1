...
export default async function ProductsPage({
  ...
  try {
    const cats = await query<{ category: string }>('SELECT DISTINCT category FROM products ORDER BY category ASC');
    ...
    <main className="section" style={{ minHeight: '80vh' }}>
      <div className="container">
        <div style={{ marginBottom: '40px' }}>
          <h1 style={{ fontSize: '36px', fontWeight: '800', marginBottom: '8px' }}>Store Catalog</h1>
          <p style={{ color: 'var(--text-secondary)' }}>
            Browse through our premium selection of tech, apparel, and fitness gear.
          </p>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr', gap: '40px' }} className="catalog-layout">
          {/* Sidebar Filters */}
          ...
          <section>
            ...
            {products.length > 0 ? (
              ...
              <div style={{
                ...
                <h3 style={{ fontSize: '20px', fontWeight: '700', marginBottom: '8px' }}>No products match your filters</h3>
